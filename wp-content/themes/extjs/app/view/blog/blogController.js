Ext.define('AppsBoard.view.blog.blogController', {
    ...
    onSelectGrid: function( grid, record, index, eOpts ){
    	var data = [{"title": "New", "content" : 'dsdasdasds'}];
        Ext.getCmp('bolg-article').update(data);    
    },
    onChangeClick: function (tree, node) {
    	console.log(node.data.id);
    	var gridList = this.lookupReference('profiletimelinepanel');
    	console.log(gridList);
    	gridList.getStore().getProxy().extraParams =  {
